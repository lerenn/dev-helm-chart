...
.PHONY: otel-lgtm/package
otel-lgtm/package: ## Package OpenTelemetry Collector with LGTM
	@${HELM_CMD} package otel-lgtm
...
.PHONY: temporal/package
temporal/package: ## Package Temporal
	@${HELM_CMD} package temporal-dev
